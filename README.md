...
Check for data quality (e.g., missing values, duplicates).
Understand distributions of variables.
Identify relationships between features.
Uncover patterns and anomalies (outliers).
Generate hypotheses and insights
![image](https://github.com/user-attachments/assets/7ce63df4-e3dc-47d2-a093-e5774c088685)
